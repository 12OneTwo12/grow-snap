...
class UserProfileRepositoryTest {
    ...
    fun save_Success() {
        // When
        val savedProfile = userProfileRepository.save(testProfile)
    ...
    fun findByNickname_ExistingProfile_ReturnsProfile() {
        ...
        // When
        val foundProfile = userProfileRepository.findByNickname(testProfile.nickname)
    ...
    fun findByNickname_NonExistingProfile_ReturnsNull() {
        // When
        val foundProfile = userProfileRepository.findByNickname("nonexistent-nickname")
    ...
    fun update_ChangeNicknameAndBio_Success() {
        ...
        // When
        val result = userProfileRepository.update(updatedProfile)
    ...
    fun existsByNickname_ExistingNickname_ReturnsTrue() {
        ...
        // When
        val exists = userProfileRepository.existsByNickname(testProfile.nickname)
    ...
    fun existsByNickname_NonExistingNickname_ReturnsFalse() {
        // When
        val exists = userProfileRepository.existsByNickname("nonexistent-nickname")
    ...
    fun save_DuplicateNickname_ThrowsException() {
        ...
        assertThrows(Exception::class.java) {
            userProfileRepository.save(duplicateProfile)
        }
    }
